        ...
        <>
            ...
            <div className={nav ? "left__bar_toggle" : "left__bar"}>
                ...
                <div className={nav ?  "logo__section_toggle" : "logo__section"}>
                    <img src={require("../../Images/Wikipedia-logo-v2.png")} alt="logo" className="logo" />
                    <img src={require("../../Images/Wikipedia_wordmark.png")} alt="logo" className="logo__letters" />
                ...
                <div className={nav ?  "menu__section__toggle"  : "menu__section"}>
                    ...
                    <a href="/" >download as <span style={{ textTransform: 'uppercase' }}>PDF</span></a>
